...
public class SQLMappingDatabase {
    ...
    private long maxProgress, lastProgress = 0, time, progress = 0;
    ...
    public void createAcc2gcf2taxidTable(File acc2gcf2taxid) {
        try {
            ...
            int count = 0;
            maxProgress = acc2gcf2taxid.length();
    ...
    private void reportProgress(int delta) {
        progress += delta;
        int p = ((int) ((((double) progress / (double) maxProgress)) * 100) / 5) * 5;
